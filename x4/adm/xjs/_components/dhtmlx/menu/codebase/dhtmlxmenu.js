...
function dhtmlXMenuObject(baseId, skin) {
    ...
    if (!this.extendedModule) {
        ...
        var extMethods = ["setItemEnabled", "setItemDisabled", "isItemEnabled", "_changeItemState", "getItemText", "setItemText",
 ...
 case "dhx_skyblue":
    ...
    this._addSubItemToSelected = function (item, polygon) {
        ...
        if (t == true) {
            this._selectedSubItems.push([item, polygon])
        }
        return t
    };
...
dhtmlXMenuObject.prototype.unload = function () {
    ...
    this.setSkin = null;
    var basicMethods = ["_enableDacSupport", "_selectedSubItems", "_openedPolygons", "_addSubItemToSelected", "_removeSubItemFromSelected",
 ...
 "dhx_Event", "unload", "_hideContextMenu", "items", "radio", "dacCycles", "dacCyclesIE"];for (var q=0;q<basicMethods.length;q++)this[basicMethods[q]] = null;basicMethods = null;var extMethods = ["setItemEnabled", "setItemDisabled", "isItemEnabled", "_changeItemState", "getItemText", "setItemText",
 "loadFromHTML", "hideItem", "showItem", "isItemHidden", "_changeItemVisible", "setUserData", "getUserData",
 "setOpenMode", "setWebModeTimeout", "enableDynamicLoading", "_updateLoaderIcon", "getItemImage", "setItemImage",
 "clearItemImage", "setAutoShowMode", "setAutoHideMode", "setContextMenuHideAllMode", "getContextMenuHideAllMode",
 "setVisibleArea", "setTooltip", "getTooltip", "setHotKey", "getHotKey", "setItemSelected", "setTopText", "setRTL",
