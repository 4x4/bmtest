...
//#}	
	...
	*/
	this.createWindow = function(id, x, y, width, height) {
		...
		win.icons = [this.imagePath+this.pathPrefix+this.skin+"/active/icon_normal.gif", this.imagePath+this.pathPrefix+this.skin+"/inactive/icon_normal.gif"];
		//
		win._allowMove = true;
...
//#}	
	...
	this._getWindowIcon = function(win) {
		if (win.iconsPresent) {
			return [win.icons[0], win.icons[1]];
		} else {
			return [null, null];
		}
	};
