                    ...
                    case "candlestick":
                        if (!isNaN(la) && !isNaN(V)) {
                            ...
                            if (r) {
                                ...
                                wb && V >= la && (Ra = 0);
                                var na = new AmCharts.Cuboid(e, L, ea, D, I, Ha, Ra, Y, ta, T, ha, t, r, aa, Za, jb, ma),
                                    Ab, Bb;
...
AmCharts.ChartCursor = AmCharts.Class({
    ...
    setPosition: function(a, b, c) {
        void 0 === b && (b = !0);
        if ("cursor" == this.type) {
            if (this.tempPosition = NaN, AmCharts.ifArray(this.data)) isNaN(a) && (a = this.getMousePosition()), (a != this.previousMousePosition || !0 === this.zoomed || this.oneBalloonOnly) && !isNaN(a) &&
                ("mouse" == this.cursorPosition && (this.tempPosition = a), isNaN(c) && (c = this.chart.categoryAxis.xToIndex(a)), c != this.previousIndex || this.zoomed || "mouse" == this.cursorPosition || this.oneBalloonOnly) && (this.updateCursor(c, b), this.zoomed = !1), this.previousMousePosition = a
    ...
    normalizeBulletSize: function() {
        ...
        if (a)
            for (var b = 0; b < a.length; b++) {
                var c = a[b],
                    d = c.bulletGraphics;
                d && (d.translate(c.bx, c.by, 1), c = c.graph, isNaN(this.graphBulletAlpha) || (d.setAttr("fill-opacity",
                ...
                if (c.mouseIsOver || A || C || this.forceShow)
                    if (this.forceShow = !1, C) {
                        ...
                        0 !== e && (h = {
                            ...
                            !g.equalSpacing ? (c + e > w && (e = w - c), A + e < u && (e = u - A), h.start = Math.round(A + e), h.end = Math.round(c + e), this.fire(h.type, h)) : H + e >= this.data.length || 0 > l + e || (h.start = l + e, h.end = H + e, this.fire(h.type, h)))
                    } else {
                        ...
                        z = !0;
                        A && (z = !1);
                        this.categoryBalloonEnabled && z ? (this.setBalloonPosition(x,
                            g, q, t), (u = this.categoryBalloonFunction) ? x.showBalloon(u(r.category)) : g.parseDates ? (g = AmCharts.formatDate(r.category, this.categoryBalloonDateFormat, c), -1 != g.indexOf("fff") && (g = AmCharts.formatMilliseconds(g, r.category)), x.showBalloon(g)) : x.showBalloon(AmCharts.fixNewLines(r.category))) : x.hide();
                        B && this.bulletsEnabled && this.showBullets();
                        if (this.oneBalloonOnly) {
                            q = Infinity;
                            for (g = 0; g < B.length; g++) u = B[g], u.showBalloon && !u.hidden && u.balloonText && (w = r.axes[u.valueAxis.id].graphs[u.id], x = w.y, isNaN(x) || (t ?
                                Math.abs(e - x) < q && (q = Math.abs(e - x), H = u) : Math.abs(f - x) < q && (q = Math.abs(f - x), H = u)));
                        ...
                        if (a != this.previousIndex || H != this.previousMostCloseGraph)
                            if (this.normalizeBulletSize(), this.destroyValueBalloons(), this.resizedBullets = [], B && this.valueBalloonsEnabled && z && c.balloon.enabled) {
                                ...
                                for (g = 0; g < B.length; g++)
                                    if (u = B[g], x = NaN, (!this.oneBalloonOnly || u == H) && u.showBalloon && !u.hidden && u.balloonText && ("step" == u.type && "left" == u.stepDirection && (r = this.data[a +
                                            1]), r)) {
                                        ...
                                        if (!isNaN(x)) {
                                            ...
                                            k && (k = this.graphBulletSize, D = this.graphBulletAlpha, 1 == k && isNaN(D) || !AmCharts.isModern || !(y = w.bulletGraphics) || (y.getBBox(), y.translate(w.bx, w.by, k), this.resizedBullets.push(w), isNaN(D) || (y.setAttr("fill-opacity",
        ...
        if (a) {
            ...
            if (this.enabled && 0 < b.length) {
                if (this.pan) this.rolledOver = !1;
                    ...
                    c.target = this;
                    c.chart = a;
                    if ("cursor" == this.type) this.rotate ? this.selectionPosY =
                        ...
                        3 > Math.abs(d - g) && 3 > Math.abs(e - h) || (b = Math.min(g, d), f = Math.min(h, e), d = Math.abs(g -
                            d), e = Math.abs(h - e), a.hideXScrollbar && (b = 0, d = this.width), a.hideYScrollbar && (f = 0, e = this.height), c.selectionHeight = e, c.selectionWidth = d, c.selectionY = f, c.selectionX = b, this.skipZoomDispatch || this.fire(c.type, c))
                    }
                    this.selectWithoutZooming || AmCharts.remove(this.selection)
                }
    ...
    handleMouseDown: function(a) {
        if (this.zoomable || this.pan || this.drawing) {
            var b = this.rotate,
                ...
                d = c.mouseX - this.x,
                e = c.mouseY - this.y;
            if (0 < d && d < this.width && 0 < e && e < this.height || "fake" == a) this.setPosition(), this.selectWithoutZooming && AmCharts.remove(this.selection), this.drawing ? (this.drawStartY = e, this.drawStartX = d, this.drawingNow = !0) : this.pan ? (this.zoomable = !1, c.setMouseCursor("move"), this.panning = !0, this.panClickPos = b ? e : d, this.panClickStart =
