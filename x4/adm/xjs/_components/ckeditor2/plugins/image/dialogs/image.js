                    ...
                    children: [{
                        ...
                        children: [{
                            ...
                            onClick: function(e) {
                                    ...
                                    AI.fileManager.open(11000);                                  
									var el=$('#'+e.sender.domId);
									
                                    AI.fileManager.currentClickItemHandler=function(id){
                                    itemPath=AI.fileManager.getPathForCurrentElement(id);                                     
                                    el.closest('tr').find('input').val(itemPath);
                                    AI.fileManager.fileman.hide();
                                     }.bind(AI.fileManager);
                                },
                    ...
                    children: [{
                        ...
                        children: [{
                            ...
                            html: "<div>" + CKEDITOR.tools.htmlEncode(c.lang.common.preview) + '<br><div id="' + m + '" class="ImagePreviewLoader" style="display:none"><div class="loading">&nbsp;</div></div><div class="ImagePreviewBox"><table><tr><td><a href="javascript:void(0)" target="_blank" onclick="return false;" id="' +
                                A + '"><img id="' + z + '" alt="" /></a>' + (c.config.image_previewText || "Lorem ipsum dolor sit amet, consectetuer adipiscing elit.") +
                                "</td></tr></table></div></div>"
                        }]
                    }]
                }]
