...
class XImport extends \xSingleton
{
    ...
    public function getColumnModifiersByType($type)
    {
        ...
        if (!isset($out)) {
            foreach ($this->proccesor->columnModifiers as $name => $modifier) {
    ...
    {
        return $this->proccesor->columnModifiers;
    }
    ...
    public function setInternalIds($list)
    {
        $this->proccesor->setInternalIds($list);
    }
    ...
    public function initiateProcessor($file,$options)
    {
        ...
        $this->proccesor = new $class($this, $file, $options);
    ...
    public function processTableImport($file, $options = array())
    {
        ...
        return $this->proccesor->preConstruct();
    }
