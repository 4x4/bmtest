...
class DropboxClient {
	...
	public function DownloadFile($dropbox_file, $dest_path='', $rev=null, $progress_changed_callback = null)
	{
        ...
        {
                $localMtime=filemtime ($dest_path);
                $modifiedOnDropBox=strtotime($dropbox_file->modified);
                if($modifiedOnDropBox<$localMtime)return $dest_path;
        }
  ...
  function DeltaLate()         
    ...
    {
        return $this->apiCall("delta/latest_cursor", "POST");
    }
