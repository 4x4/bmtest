usersBack = new Class(
    {
        ...
        initialize: function (name) {
            ...
            AI.loadJs('/x4/modules/users/js/usersBackObjects.js', false);
            this.objTypeScope = new Array('_USERSGROUP');
            this.pushToTreeClickMap('_USERSGROUP', 'showUsersList');

        },

        CRUN: function () {
            this.USER = new _USER(this);
            this.USERSGROUP = new _USERSGROUP(this);
            ...
            var oTabs = [
                {
                    ...
                    id: 'tcreate_USER',
                    name: AI.translate('users', 'new_user'),
                    href: AI.navHashCreate(this.name, 'create_USER')
                },

                {
                    id: 'tcreate_USERSGROUP',
                    name: AI.translate('users', 'add-user-group'),
                    href: AI.navHashCreate(this.name, 'create_USERSGROUP')
                }
        ...
        dialogGroupTreeDynamicXLS: function (id) {
            this.connector.execute({treeDynamicXLSUsers: {id: id}});
        ...
        onSearchInModule: function (result) {
            ...
            this.setGridView('searchResultsContainerUsers', 750, true);
            ...
            this.sgridlist = new dhtmlXGridObject('searchResultsContainerUsers');
            this.sgridlist.setImagePath("/x4/adm/xres/ximg/grid/imgs/");
            this.sgridlist.setHeader('id,' + AI.translate('common', 'type') + ',' + AI.translate('users', 'login') + ',' + AI.translate('common', 'name') + ',' + AI.translate('users', 'surname') + ',' + AI.translate('users', 'email'));
        ...
        searchGridObjectClicked: function (id) {
            AI.navigate(AI.navHashCreate(this.name, 'edit_USER', {'id': id}));
        },
        ...
        buildInterface: function () {
            ...
            menu.addNewChild(menu.topId, 0, "edit", AI.translate('users', 'edit_group'), false, '', '', function (id, kid) {
                this.navigate('edit_USERSGROUP', {id: kid});
            }.bind(this));
            menu.addNewChild(menu.topId, 0, "delete", AI.translate('common', 'delete'), false, '', '', this.USERSGROUP.deleteGroup.bind(this.USERSGROUP));
            ...
            this.tree.setHeader(AI.translate('users', 'group_name'));
...
/*var XTRusers = Class.create();
 ...
 {
 XTR_main.load_module_tpls(this.module_name, ['roles_table','roles_editor','roles_add_role']);
