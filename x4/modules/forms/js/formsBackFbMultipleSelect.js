/*
 * JQuery Form Builder - Multiple plugin.
 */

var FbMultipleSelect = jQuery.extend({}, jQuery.fb.fbWidget.prototype,
{
    fbOptions: {
        Name: AI.translate('forms', 'MultipleSelect'),
        belongsTo: jQuery.fb.formbuilder.prototype.fbOptions._standardFieldsPanel,
        _type: 'MultipleSelect',
        _html : '<div class="MultipleSelect col-lg-11"><label class="control-label"><span></span><em></em></label> \
              <select class="form-control input-sm textInput" multiple="1">\
                <option value="0">'+AI.translate('forms', 'option')+' 1</option>\
                <option value="0">'+AI.translate('forms', 'option')+' 2</option>\
                <option value="0">'+AI.translate('forms', 'option')+' 3</option>\
              </select> \
            <p class="help-block m-b-none formHint"></p></div>',
        _btnHtml: '<div class="form-group"> \
            <label class="control-label">'+AI.translate('forms', 'MultipleSelect')+'</label> \
            <select name="selectmultiple" class="form-control m-b input-sm" disabled="1" multiple="1" style="background-color: #FFFFFF; cursor: pointer;"> \
            ...
            <span class="help-block m-b-none">'+AI.translate('forms', 'MultipleSelect_text_help')+'</span></div> \
            <div class="line line-dashed b-b line-lg pull-in"></div>',
        _counterField: 'label',
        //_languages: [ 'en_EN', 'ru_RU' ],
        settings: {
            label: AI.translate('forms', 'MultipleSelect'),
            value: '',
            description: ''
        }
    },
...
jQuery.widget('fb.fbMultipleSelect', FbMultipleSelect);
