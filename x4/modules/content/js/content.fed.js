...
function content_drag_control() {
    this._drag = function (sourceHtmlObject, dhtmlObject, targetHtmlObject) {
        ...
        html = FXTR_pages.create_module(slot_id, {
            Alias: 'content',
            contentId: id,
            Action: 'show_content',
            Active: 1,
...
FXTRcontent.prototype =
    {
        ...
        get_module_prototype_vcontext: function (ocontext) {
            ocontext.insert(XTR_FED.modulePrototypeAction({
                actType: 'act2',
                name: _lang_common['change'],
                backFunc: this.onEdit.bind(this)
            }));
        }
        ,
        get_action_properties: function (_action, prefix) {
            ...
            if (this.connector.result.xlist) {
                ...
                _columnsHeadersWidth = ['20px', '150px'];
            ...
            if (da.defaultAction) {
                this.get_action_properties(da.defaultAction, 'secondary');
            }
